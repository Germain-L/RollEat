<template>
	<v-container justify="center">
		<v-col class="col-8 offset-2" justify="center" align="center">
			...
			<v-text-field v-model="password" :append-icon="showPassword? 'mdi-eye': 'mdi-eye-off' " label="Password" :type="showPassword? 'text': 'password' " @click:append="showPassword = !showPassword">
			</v-text-field>
